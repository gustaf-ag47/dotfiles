...
local function nearest_test_filter()
  ...
  if not method then return class end
...
return {
  ...
  keys = {
    ...
    { '<leader>Tu', function() open_term('make test-unit') end,        desc = 'make test-unit' },
    { '<leader>Ti', function() open_term('make test-integration') end, desc = 'make test-integration' },
    { '<leader>Ta', function() open_term('make test-api') end,         desc = 'make test-api' },
  },
  config = function()
